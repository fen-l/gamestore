...
const makeReviews = (seed: string) => [
  {
    id: seed + "-r1",
    author: "Анна К.",
    rating: 5,
    date: "2025-03-12",
    text: "Отличная игра, вся семья в восторге!",
  },
  {
    id: seed + "-r2",
    author: "Игорь М.",
    rating: 4,
    date: "2025-02-04",
    text: "Качество компонентов на высоте, правила понятные.",
  },
  {
    id: seed + "-r3",
    author: "Мария В.",
    rating: 5,
    date: "2025-01-20",
    text: "Играем каждые выходные, не надоедает.",
  },
];
